...
import {
  Globe, TrendingUp, User, BarChart3, Target, Flame, LineChart, Brain, BookOpen, Building2, Home, Bot, MessageSquare, Eye, Network, GraduationCap, Briefcase, Wallet, Receipt, Lock, Activity, Layers, LucideIcon
} from "lucide-react";
import {
  Sidebar,
  SidebarContent,
