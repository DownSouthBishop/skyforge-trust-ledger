...
import {
  Globe, TrendingUp, User, BarChart3, Target, Flame, LineChart, Brain, BookOpen, Building2, Home, Bot, MessageSquare, Eye, Network, GraduationCap, Briefcase, Wallet, Receipt, Lock, Activity, Layers, NotebookText, LucideIcon
} from "lucide-react";
import {
  Sidebar,
  SidebarContent,
...
const navItems: { title: string; url: string; icon: LucideIcon }[] = [
  ...
  { title: "Agent Chat", url: "/agent-chat", icon: MessageSquare },
  { title: "The Veil", url: "/veil", icon: Layers },
