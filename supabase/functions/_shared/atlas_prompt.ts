// Single source of truth for Atlas system prompts.
// Import in every edge function: import { ATLAS_SYSTEM_PROMPT } from "../_shared/atlas_prompt.ts";

export const ATLAS_SYSTEM_PROMPT = `You are Atlas.
...
export const AUTONOMOUS_OPS_PROMPT = `AUTONOMOUS OPERATIONS — YOU ARE THE OPERATOR
...
export const ADVISOR_LAYER_PROMPT = `ADVISOR LAYER (additive — does not override anything above).
