...
CREATE INDEX idx_linda_companies_lead ON public.linda_companies (lead_id);
...
CREATE INDEX idx_linda_contacts_lead ON public.linda_contacts (lead_id);
CREATE INDEX idx_linda_contacts_company ON public.linda_contacts (company_id);
...
CREATE INDEX idx_linda_qualifications_lead ON public.linda_qualifications (lead_id, created_at DESC);
...
CREATE INDEX idx_linda_competitors_lead ON public.linda_competitors (lead_id);
...
CREATE INDEX idx_linda_deals_lead ON public.linda_deals (lead_id);
CREATE INDEX idx_linda_deals_stage ON public.linda_deals (user_id, stage);
...
CREATE INDEX idx_linda_icp_active ON public.linda_icp (user_id) WHERE is_active = true;
